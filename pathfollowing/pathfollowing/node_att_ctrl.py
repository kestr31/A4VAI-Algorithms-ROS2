...
# added by controller
        ...
        self.waypoint_convert_flag_subscriber       =   self.create_subscription(Bool ,                   '/waypoint_convert_flag',            self.pass_waypoint, 10)
#############################################################################################################
...
#############################################################################################################
        ...
        self.datalogFile = open("/home/user/workspace/ros2/ros2_ws/log/point_mass_6d/datalogfile/datalog.txt",'w')
    ...
    def main_attitude_control(self):
        if self.controller_heartbeat == True and self.path_planning_heartbeat ==True and self.collision_avoidance_heartbeat == True:
            ...
            if self.variable_setting_complete == True :
                ...
                self.Q6_WP_idx_passed = self.Q6.WP_idx_heading-1
                # print('p_closest_on_path',self.Q6.p_closest_on_path)
                # print('WP_idx_passed',self.Q6.WP_idx_passed)
                ...
                # print('WP_idx_heading',self.Q6.WP_idx_heading)
...
# receive local waypoint from controller
    ...
    def pass_waypoint(self,msg):
        self.Q6.WP_idx_heading  =   self.Q6.WP_idx_heading + 1
        print(self.Q6.WP_idx_heading)
        print(self.Q6.WP_idx_passed)
