...
class Controller(Node):
    def __init__(self):
        ...
        self.collision_avoidance_start          = False
        ...
        self.collision_avidance_time = 100
        self.collision_avidance_elapsed_time = 0
        ...
        self.flightlogFile = open("/home/user/workspace/ros2/ros2_ws/log/flight_log.txt",'w')
        self.datalogFile = open("/home/user/workspace/ros2/ros2_ws/log/data_log.txt",'w')

        ## initialize path planning parameter
        # path planning global waypoint [x, z, y]
        self.start_point        =   [50.0, 10.0, 50.0]
        ...
        self.waypoint_convert_flag_publisher            =   self.create_publisher(Bool,                             '/waypoint_convert_flag',           10)
